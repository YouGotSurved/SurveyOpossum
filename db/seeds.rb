...
andrew_questions2 = Question.create!({survey_id: andrew_survey.first.id, order_number: 2, question_type: "string" , text: "Example Text 2!", required: true})
marcia_questions2 = Question.create!({survey_id: marcia_survey.first.id, order_number: 2, question_type: "string" , text: "Example Text 2!", required: true})
joseph_questions2 = Question.create!({survey_id: joseph_survey.first.id, order_number: 2, question_type: "string" , text: "Example Text 2!", required: true})
dennis_questions2 = Question.create!({survey_id: dennis_survey.first.id, order_number: 2, question_type: "string" , text: "Example Text 2!", required: true})
andrew_questions3 = Question.create!({survey_id: andrew_survey.first.id, order_number: 3, question_type: "string" , text: "Example Text 3!", required: true})
marcia_questions3 = Question.create!({survey_id: marcia_survey.first.id, order_number: 3, question_type: "string" , text: "Example Text 3!", required: true})
joseph_questions3 = Question.create!({survey_id: joseph_survey.first.id, order_number: 3, question_type: "string" , text: "Example Text 3!", required: true})
dennis_questions3 = Question.create!({survey_id: dennis_survey.first.id, order_number: 3, question_type: "string" , text: "Example Text 3!", required: true})
